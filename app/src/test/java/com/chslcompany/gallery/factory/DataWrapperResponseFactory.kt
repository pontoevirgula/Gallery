package com.chslcompany.gallery.factory

import com.chslcompany.gallery.framework.network.response.DataWrapperResponse
import com.chslcompany.gallery.framework.network.response.Photo
import com.chslcompany.gallery.framework.network.response.Src
